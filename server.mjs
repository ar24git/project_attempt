...
app.post("/register", async(req, res)=>{
  ...
  const result = await db.query(
    ...
    "VALUES ('Nicolas');"+
    "SELECT lastval(); -- This will return the last value generated by a sequence (in this case, the ID from the person table)"+
    "INSERT INTO administrator (id, email, password_hash)"+
    "VALUES (lastval(), $1, $2);",
    [email, password]
  );
  console.log(result);
